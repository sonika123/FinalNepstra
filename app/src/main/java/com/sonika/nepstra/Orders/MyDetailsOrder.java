...
import com.sonika.nepstra.adapters.MyDetailsOrderAdapter;
...
public class MyDetailsOrder extends AppCompatActivity {
    ...
    MyDetailsOrderAdapter myOrderAdpater = null;
...
//                            allmyorderlist.add(myorder);
        ...
        protected void onPostExecute(String s) {
            ...
            if (flag == 1) {
                ...
                myOrderAdpater = new MyDetailsOrderAdapter(MyDetailsOrder.this, allmyorderlist);
